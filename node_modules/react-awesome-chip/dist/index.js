...
var DivWrapper = function DivWrapper(_ref) {
  ...
  return React__default.createElement("div", Object.assign({}, props), children);
};
...
var Chip = function Chip(_ref2) {
  ...
  var Wrapper = onClick ? core.ButtonBase : DivWrapper;
...
var ChipsView = function ChipsView(_ref3) {
  ...
  return React__default.createElement(core.Grid, {
    ...
    }, React__default.createElement(Chip, Object.assign({}, props)));
  }));
};
  ...
  var FilterView = function FilterView(_ref4) {
    ...
    return React__default.createElement(core.Grid, {
      ...
      return React__default.createElement(core.Grid, {
        item: true,
        key: index
      }, React__default.createElement(Chip, {
        color: data.color,
        title: data.title,
        size: data.size || 'md',
...
exports.Chip = Chip;
exports.ChipsView = ChipsView;
exports.useFilterView = useFilterView;
